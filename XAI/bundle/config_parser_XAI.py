# Needs to be located at "pbi/pbi_utils/config_parser_XAI.py"
...
class Config:
    ...
    def __init__(self, yaml_config: YAMLConfig, raw_dict):
        ...
        ''' new instancies used on the main pipeline '''
        ...
        ''' standalone instances - using "bundle" instead of "output" folder '''
